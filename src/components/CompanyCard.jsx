...
const CompanyCard = ({ cmp }) => {
  return (
    <div className='w-full h-960 grid  gap-4 items-center justify-between bg-white shadow-md rounded'>
      <div className='w-3/4 md:w-2/4 grid gap-4 items-center'>
        <div>
      ...
      <div className='hidden w-1/4 h-full md:flex items-center'>
        <p className='text-base text-start'> Location : {cmp?.location}</p>
      </div>
