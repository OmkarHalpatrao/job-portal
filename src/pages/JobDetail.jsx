  ...
  const handleApplyNow = async () => {
    ...
    try {
      const applicationData = {
        ...
        email: user?.email,
        contact: user?.contact, // Make sure you have this data available in your user object
        resume: 'URL_to_user_resume', // Replace with the actual resume URL
        coverLetter: 'User_cover_letter', // Replace with the actual cover letter
      };
      ...
      if (res?.success) {
        ...
        setJob(prevJob => ({ ...prevJob, applicants: prevJob?.applicants + 1 }));
        
        // Optionally, update the UI or perform any action after successful application
      }
      setIsFetching(false);
    } catch (error) {
      setIsFetching(false);
